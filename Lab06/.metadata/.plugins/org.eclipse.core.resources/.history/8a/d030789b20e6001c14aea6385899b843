	...
	public static void main(String[] args) {
		...
		if (firstoption == 1) {
			...
			if (fourthoption == 0) {
				...
				if (Categoryadded.equals("DigitalVideoDisc") == true) {
				...
				else if(Categoryadded.equals("CompactDisc") == true) {
					...
					Book Bookadded = new Book(Titleadded,Categoryadded,Costadded,authors);
